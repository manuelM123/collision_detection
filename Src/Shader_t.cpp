...
Shader_t::Shader_t(const char* vertexPath, const char* fragmentPath, const char* geometryPath, const char* tessControlPath, const char* tessEvalPath){
...
void Shader_t::setVec4(const std::string &name, float x, float y, float z, float w) const
{
...
void Shader_t::checkCompileErrors_t(GLuint shader, std::string type)
{
    GLint success;
    GLchar infoLog[1024];
    if(type != "PROGRAM")
